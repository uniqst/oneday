...
<form class="" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">

	<h2 style="cursor:pointer"><a class="shipping-calculator-button"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?> <i class="fa fa-angle-double-down"></i></a> </h2>
