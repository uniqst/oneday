...
function alpha_store_theme_stylesheets() {
	...
	wp_enqueue_style( 'alpha-store-stylesheet', get_stylesheet_uri(), array(), '1.3.0', 'all' );
...
function alpha_store_theme_js() {
	...
	wp_enqueue_script( 'alpha-store-theme-js', get_template_directory_uri() . '/js/customscript.js', array( 'jquery' ), '1.3.0' );
